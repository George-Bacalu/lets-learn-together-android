...
public class Utils {
    ...
    private void initData(Context context) {
        ...
        categories.add(new Category(1, getStringResource(context, R.string.A), R.drawable.dactilema_a));
        // categories.add(new Category(2, getStringResource(context, R.string.A), R.drawable.dactilema_a));
        // categories.add(new Category(3, getStringResource(context, R.string.A), R.drawable.dactilema_a));
        categories.add(new Category(4, getStringResource(context, R.string.B), R.drawable.dactilema_b));
        categories.add(new Category(5, getStringResource(context, R.string.C), R.drawable.dactilema_c));
        categories.add(new Category(6, getStringResource(context, R.string.D), R.drawable.dactilema_d));
        categories.add(new Category(7, getStringResource(context, R.string.E), R.drawable.dactilema_e));
        categories.add(new Category(8, getStringResource(context, R.string.F), R.drawable.dactilema_f));
        categories.add(new Category(9, getStringResource(context, R.string.G), R.drawable.dactilema_g));
        categories.add(new Category(10, getStringResource(context, R.string.H), R.drawable.dactilema_h));
        categories.add(new Category(11, getStringResource(context, R.string.I), R.drawable.dactilema_i));
        // categories.add(new Category(12, getStringResource(context, R.string.I), R.drawable.dactilema_i));
        categories.add(new Category(13, getStringResource(context, R.string.J), R.drawable.dactilema_j));
        categories.add(new Category(14, getStringResource(context, R.string.K), R.drawable.dactilema_k));
        categories.add(new Category(15, getStringResource(context, R.string.L), R.drawable.dactilema_l));
        categories.add(new Category(16, getStringResource(context, R.string.M), R.drawable.dactilema_m));
        categories.add(new Category(17, getStringResource(context, R.string.N), R.drawable.dactilema_n));
        categories.add(new Category(18, getStringResource(context, R.string.O), R.drawable.dactilema_o));
        categories.add(new Category(19, getStringResource(context, R.string.P), R.drawable.dactilema_p));
        categories.add(new Category(20, getStringResource(context, R.string.Q), R.drawable.dactilema_q));
        categories.add(new Category(21, getStringResource(context, R.string.R), R.drawable.dactilema_r));
        categories.add(new Category(22, getStringResource(context, R.string.S), R.drawable.dactilema_s));
        // letters.add(new Category(23, getStringResource(context, R.string.S),R.drawable.dactilema_s));
        categories.add(new Category(24, getStringResource(context, R.string.T), R.drawable.dactilema_t));
        // letters.add(new Category(25, getStringResource(context, R.string.T), R.drawable.dactilema_t));
        categories.add(new Category(26, getStringResource(context, R.string.U), R.drawable.dactilema_u));
        categories.add(new Category(27, getStringResource(context, R.string.V), R.drawable.dactilema_v));
        categories.add(new Category(28, getStringResource(context, R.string.W), R.drawable.dactilema_w));
        categories.add(new Category(29, getStringResource(context, R.string.X), R.drawable.dactilema_x));
        categories.add(new Category(30, getStringResource(context, R.string.Y), R.drawable.dactilema_y));
        categories.add(new Category(31, getStringResource(context, R.string.Z), R.drawable.dactilema_z));
