...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sections.add(new Section(10002, "Secţiune Text - Dactilemă", R.drawable.ic_text_to_sign_section, R.drawable.text_to_sign_section));
        sections.add(new Section(10003, "Secţiune Voce - Dactilemă", R.drawable.ic_voice_to_sign_section, R.drawable.voice_to_sign_section));
