...
import com.example.llt_project_separate.video_section.people.family_members.FamilyMembersActivity;
import com.example.llt_project_separate.video_section.people.pronouns.PronounsActivity;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.categoryCard.setOnClickListener(v -> {
            ...
            switch(people.get(position).getId()) {
                case 155: intent = new Intent(peopleContext, FamilyMembersActivity.class); break;
                case 156: intent = new Intent(peopleContext, PronounsActivity.class); break;
